...
public final class InMemorySpanStore implements SpanStore {
   ...
   * other maps are derived from the span values here.
   *
  ...
  private final SortedMultimap<Pair<Long>, Span> spansByTraceIdTimeStamp =
      new LinkedHashSetSortedMultimap<>(VALUE_2_DESCENDING);
  ...
  private final SortedMultimap<String, Pair<Long>> serviceToTraceIdTimestamp =
      new SortedByValue2Descending<>(String::compareTo);
  ...
  static final class SortedByValue2Descending<K> extends SortedMultimap<K, Pair<Long>> {
    SortedByValue2Descending(Comparator<K> keyComparator) {
      super(keyComparator);
    }
